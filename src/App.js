...
function Details(props) {
  return (
    <div className="card">
      ...
      <hr></hr>
      <p class="para">{props.user}</p>
      <p class="para">{props.storage}</p>
      <p class="para">{props.publicProjects}</p>
      <p class="para">{props.comAcc}</p>
      <p class="para">{props.prvPro}</p>
      <p class="para">{props.phSup}</p>
      <p class="para">{props.subdom}</p>
      <p class="para">{props.msp}</p>
